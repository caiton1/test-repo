...
---
  ...
  User Stats:<br>
  ![User Draft Stats](/userCards/draft-1718001173188.svg?)
...
Quest:
  - Quest 2 - Introducing yourself to the community
    - Task 1 - [Choose an issue that you would like to work with](https://github.com/caiton1/test-repo/issues/33)
